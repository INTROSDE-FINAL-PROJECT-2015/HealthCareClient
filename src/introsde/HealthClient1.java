...
public class HealthClient1{
  ...
  public static void main(String[] args) throws IOException {
    ...
    int exit = 0;
    while (exit == 0){
       asd("\n\t Press  1  to have a look to your last measurements");
       asd("\n\t Press  2  to check your DailyGoals");
       asd("\n\t Press  3  to edit your DailyGoals");
       asd("\n\t Press  4  to insert measurements and check Long Term Goals");
       asd("\n\t Press  5  to exit");
       String input = userinput("\n enter a choice:");
       int answer = Integer.parseInt(input);
    switch(answer) {
     case 1:
         Person pp = getPerson(userID);
         lookMeasurements(pp);
         break;
     case 2:
        checkDailyGoals(p);
     ...
     case 4:
        ...
        break;
     case 5:
         exit = 1; // System.exit(0) or quit however you want to
     default:
  ...
  public static void lookMeasurements(Person p){
  ...
  private static void deleteDailyGoals1(Person p){
    int pid = p.getIdPerson();
    Response resInit = doGet("get/person/"+p.getIdPerson()+"/dailygoals");
    List<DailyGoal> dgl = resInit.readEntity(new GenericType<List<DailyGoal>>(){});
    if(dgl==null)
      asd("Nullo");
  ...
  private static void theMeasures(List<CustomGoal> goals){
    String ans = userinput("\n Would you like to register some health measurements? \n");
    Response res = null;
    if(ans.equals("YES") || ans.equals("yes") || ans.equals("Yes")){
      for (CustomGoal g : goals){
        try{
